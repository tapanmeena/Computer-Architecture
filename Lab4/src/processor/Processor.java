...
public class Processor {
	...
	public int getDataHazard(){
		return numberofDataHazard;
	}
	public void setDataHazard(int dataHazard){
		this.numberofDataHazard = dataHazard;
	}
	public int getPath(){
		return wrPath;
	}
	public void setPath(int wrongPath){
		this.wrPath = wrongPath;
	}
}
