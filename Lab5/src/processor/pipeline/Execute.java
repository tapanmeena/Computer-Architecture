...
public class Execute implements Element{
	...
	public void performEX()
	{
		...
		int rdEX=103;
		if(OF_EX_Latch.isOF_enable() && OF_EX_Latch.getcanContinue() && !EX_MA_Latch.isMA_busy()){
			...
			System.out.println("immediate "+ imm + " op1 "+ op1 + " op2 "+ op2);
...
*/				case "10010":
				...
				case "00111":
					...
					aluResult = op1 / imm;
					int tti = op1 % imm;
					System.out.println(tti+"   remainder");
...
//					System.out.println(imm+" tapan");
			...
			switch(isBranchTaken){
				case 1:
					Simulator.getEventQueue().removeElement();
