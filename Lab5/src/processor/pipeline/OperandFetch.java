...
public class OperandFetch {
	...
	{
		System.out.println("---> Operand Stage <---");
		System.out.println("Operand" +" "+IF_OF_Latch.isOF_enable() + " "+!MA_RW_Latch.isRW_busy()+" "+!EX_MA_Latch.isMA_busy());
		if(IF_OF_Latch.isOF_enable() && !MA_RW_Latch.isRW_busy() && !EX_MA_Latch.isMA_busy())
		{
